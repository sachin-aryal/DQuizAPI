...
if($actionName == ""){
    echo json_encode($restResult->getMessage(false,"Required parameter actionName not found."));
    return;
}
...
if($requiredMethod != $method){
    echo json_encode($restResult->getMessage(false,"The requested method is not allowed"));
    return;
}
else{
